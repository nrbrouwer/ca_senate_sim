...
"  total_votes <- nrow(votes_including_s[votes_including_s %in% c('Aye', 'No', 'Abstain')])",
...
"    width = 1/3,",
"    value_box(",
"      title = 'Voted With Party Majority',",
...
"    ),",
"    value_box(",
"      title = 'Voted Against Party Majority',",
"      value = paste0(against_votes, '%'),",
