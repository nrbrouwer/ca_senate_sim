...
bill_list$PDF <- paste0("[View Bill](", bills_dir,  "/", bill_list$url, ".pdf)")

bill_list$Page <- paste0("[Page](", b_pages_dir, "/", bill_list$url, ".html)")

# simple nice table with kableExtra
bill_list %>%
  select(bill_measure, title, name, lobbyist, committee, PDF, Page) %>% 
  gt() %>% 
